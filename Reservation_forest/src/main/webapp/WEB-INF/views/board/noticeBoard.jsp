...
<body>
	...
	<section class="rooms-section spad">
				...
				<%-- 	<form method="get" action="${pageContext.request.contextPath}/noticeall"> --%>
						<div>
							<select class="nice-select" name="condition" id="condition">
								<option class="option" selected>검색</option>
						...
						<div>
							<p>
								<input class="form-control-table" type="search"aria-label="Search" name="keyword" id="keyword"> <!--value="${param.keyword}  -->
		...
		<ul class="pagination justify-content-center">
					<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/noticeall?currentPage=1">&laquo;</a></li>
					<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/noticeall?currentPage=${ currentPage -10 }">&lt;</a></li>
					<c:forEach begin="${ currentTabStart }" end="${ currentTabEnd }" step="1" varStatus="stauts">
						<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/noticeall?currentPage=${ stauts.index}">${ stauts.index }</a></li>
					</c:forEach>
					<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/noticeall?currentPage=${ currentPage +10 }">&gt;</a></li>
					<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/noticeall?currentPage=${ totalPage }">&raquo;</a></li>
				</ul>
			</div>
		</div>
